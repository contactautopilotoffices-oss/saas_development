/**
 * WhatsAppTemplatesManager - Admin interface for viewing, editing, and managing WhatsApp
 * notification templates used throughout the AutoPilot platform.
 *
 * Provides a searchable, filterable list of system-defined WhatsApp message templates
 * organized by category (Report, Ticket, SOP, Booking, System). Each template displays its
 * trigger event, recipients, and rendered message body with variable placeholders. Admins
 * can view full template details in a modal, edit template body/name/description, copy
 * the body to clipboard, and delete non-system templates. A flow diagram component
 * visually maps every trigger event to its corresponding template and recipients,
 * serving as living documentation for the notification system.
 *
 * @example

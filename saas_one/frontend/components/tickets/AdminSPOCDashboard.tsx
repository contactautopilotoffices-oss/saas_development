/**
 * AdminSPOCDashboard
 * Admin dashboard for Single Point of Contact (SPOC) ticket management.
 * Displays escalated tickets with SLA status, confidence scores, and assignment controls.

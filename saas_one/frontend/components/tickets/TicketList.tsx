 ...
 * TicketList
 *
 * Displays a scrollable list of tickets for a given property with filtering,
 * status indicators, priority badges, SLA countdown, and escalation flags.
 *
 * Features:
 * - Fetches tickets from /api/tickets with optional status, internal, assignee, and creator filters
 * - Color-coded status and priority badges (open, in_progress, resolved, closed, etc.)
 * - SLA deadline countdown with breach highlighting
 * - Escalation level indicators
 * - Internal ticket badge

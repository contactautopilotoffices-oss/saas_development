 ...
 * PPMModule
 *
 * Preventive Plant Maintenance (PPM) module providing a tabbed interface
 * for managing scheduled maintenance, compliance tracking, and vendor relationships.
 *
 * Features:
 * - Calendar tab: scheduled maintenance task calendar
 * - Reports tab: PPM performance and completion reports
 * - AMC Contracts tab: Annual Maintenance Contract management
 * - Compliance tab: regulatory and safety compliance tracking
 * - Vendors tab: vendor management for maintenance suppliers
 *
 * @example
 * <PPMModule
 *   organizationId="org_456"
 *   propertyId="prop_123"
 *   properties={[{ id: "prop_123", name: "Building A" }]}
 * />
 */

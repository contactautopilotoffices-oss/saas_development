/**
 * UserDirectory
 * User directory and management component with search, filtering, role editing,
 * and super tenant property assignment.
 * Supports CRUD operations on users, role changes, and property membership management.
 * @remarks Client component using Supabase, AuthContext.
 */

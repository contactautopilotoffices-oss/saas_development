/**
 * StaffDashboard
 * General staff dashboard with tabs for: dashboard, requests, visitors, rooms, diesel,
 * electricity, stock, checklists, settings, profile, and flow-map.
 * Manages daily operational tasks for property staff members.

/**
 * MstDashboard
 * Maintenance Staff Team (MST) dashboard for maintenance professionals.
 * Features: shift status tracking, active ticket management, diesel/electricity readings,
 * visitor management, SOP checklists, and ticket assignment via Kanban board.

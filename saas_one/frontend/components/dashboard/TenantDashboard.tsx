/**
 * TenantDashboard
 * Tenant-facing dashboard with tabs for: overview, requests, visitors, room booking,
 * settings, and profile.
 * Enables tenants to raise tickets, book meeting rooms, and manage visitor passes.

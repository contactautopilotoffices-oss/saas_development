/**
 * Daily WhatsApp report cron.
 * Sends daily summary report to admins on WhatsApp.
 * POST /api/cron/daily-whatsapp-report
 * Auth: Cron secret.
 */
 ...
 *
 * Sends a daily open-ticket summary via WhatsApp to org super admins.
 *
 * Runs daily at 12:00 AM IST (18:30 UTC previous day) via Vercel Cron.
 * Iterates over all active organizations, aggregates open/pending-validation ticket
 * counts by priority and property, and sends a formatted WhatsApp message to all
 * org_super_admin, owner, admin, and org_admin users of each organization.
 *
 * Skips organizations with zero tickets. Results array includes per-org send status.
 *

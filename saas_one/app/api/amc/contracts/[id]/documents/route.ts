/**
 * AMC contract document upload API.
 * Uploads/manages documents (contracts, invoices, renewals, certificates) for an AMC contract.
 * POST: Upload a document | DELETE: Delete a document.

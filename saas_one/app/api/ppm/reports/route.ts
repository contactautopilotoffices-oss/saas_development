/**
 * GET /api/ppm/reports
 * Returns PPM (Preventive Planned Maintenance) compliance reports for an organization.
 * Required query params: organization_id, from_date (YYYY-MM-DD), to_date (YYYY-MM-DD)
 * Optional: property_id to narrow results to one property.
 * Computes aggregate stats: total tasks, done/pending/postponed/skipped counts,
 * and overall compliance percentage. Groups results by system_name and by month.
 * Uses supabaseAdmin to bypass RLS for cross-property reporting.

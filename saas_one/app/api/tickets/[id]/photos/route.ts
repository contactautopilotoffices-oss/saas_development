 ...
 * Upload before/after photo for a ticket. Stores in Supabase Storage (ticket_photos bucket).
 * Body (FormData): file, type ('before'|'after'), takenAt?
 * Validates: image only, max 10MB. Only ticket creator or assignee can upload.
 * Logs photo upload to ticket_activity_log.
 *

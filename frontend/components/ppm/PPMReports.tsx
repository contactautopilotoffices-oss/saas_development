...
export default function PPMReports({ organizationId, propertyId, properties = [] }: Props) {
    ...
    const [filterPropertyId, setFilterPropertyId] = useState(propertyId || '');
    ...
    }, [organizationId, fromDate, toDate, filterPropertyId]);
    ...
    return (
        <div className="flex flex-col h-full overflow-auto bg-white p-6 space-y-6">
            ...
            <div className="flex flex-wrap items-end gap-3">
                ...
                {properties.length > 0 && (
                    <div>
                        <label className="text-xs font-black text-slate-600 uppercase tracking-widest block mb-1">Property</label>
                        <select
